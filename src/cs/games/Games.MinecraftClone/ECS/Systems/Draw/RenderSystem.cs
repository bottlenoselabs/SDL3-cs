...
namespace Games.MinecraftClone.ECS.Systems.Draw;

public sealed class RenderSystem : System<CameraDrawComponent>
{
    ...
    {
        var vertexShaderFilePath = Examples.MinecraftClone.Assets.Utility.GetShaderFilePath("Minecraft.vert");
        ...
        var fragmentShaderFilePath = Examples.MinecraftClone.Assets.Utility.GetShaderFilePath("Minecraft.frag");
        if (!_fileSystem.TryLoadGraphicsShader(
