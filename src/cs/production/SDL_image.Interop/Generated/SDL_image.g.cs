// <auto-generated>
//  This code was generated by the following tool on 2025-08-12 05:52:59 GMT+00:00:
...
public static unsafe partial class SDL_image
{
    ...
    [LibraryImport(LibraryName, EntryPoint = "IMG_AddAnimationFrame")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool IMG_AddAnimationFrame(IMG_AnimationStream* stream, SDL_Surface* surface, ulong pts);

    [LibraryImport(LibraryName, EntryPoint = "IMG_CloseAnimationStream")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool IMG_CloseAnimationStream(IMG_AnimationStream* stream);

    [LibraryImport(LibraryName, EntryPoint = "IMG_CreateAnimationStream")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IMG_AnimationStream* IMG_CreateAnimationStream(CString file);

    [LibraryImport(LibraryName, EntryPoint = "IMG_CreateAnimationStream_IO")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IMG_AnimationStream* IMG_CreateAnimationStream_IO(SDL_IOStream* dst, CBool closeio, CString type);

    [LibraryImport(LibraryName, EntryPoint = "IMG_CreateAnimationStreamWithProperties")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial IMG_AnimationStream* IMG_CreateAnimationStreamWithProperties(SDL_PropertiesID props);
    ...
    public static readonly CString IMG_PROP_ANIMATION_STREAM_CREATE_FILENAME_STRING = (CString)"SDL_image.animation_stream.create.filename"u8;

    public static readonly CString IMG_PROP_ANIMATION_STREAM_CREATE_IOSTREAM_AUTOCLOSE_BOOLEAN = (CString)"SDL_image.animation_stream.create.iostream.autoclose"u8;

    public static readonly CString IMG_PROP_ANIMATION_STREAM_CREATE_IOSTREAM_POINTER = (CString)"SDL_image.animation_stream.create.iostream"u8;

    public static readonly CString IMG_PROP_ANIMATION_STREAM_CREATE_QUALITY_NUMBER = (CString)"SDL_image.animation_stream.create.quality"u8;

    public static readonly CString IMG_PROP_ANIMATION_STREAM_CREATE_TIMEBASE_DENOMINATOR_NUMBER = (CString)"SDL_image.animation_stream.create.timebase.denominator"u8;

    public static readonly CString IMG_PROP_ANIMATION_STREAM_CREATE_TIMEBASE_NUMERATOR_NUMBER = (CString)"SDL_image.animation_stream.create.timebase.numerator"u8;

    public static readonly CString IMG_PROP_ANIMATION_STREAM_CREATE_TYPE_STRING = (CString)"SDL_image.animation_stream.create.type"u8;
