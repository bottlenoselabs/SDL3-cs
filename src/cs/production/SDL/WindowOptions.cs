...
public sealed class WindowOptions : BaseOptions
{
    ...
    /// <summary>
    ///     Gets or sets a value indicating whether the window should use high pixel density back buffer. Default
    ///     is <c>false</c>.
    /// </summary>
    public bool UsesHighPixelDensityBackBuffer { get; set; }
    ...
    protected override void OnReset()
    {
        ...
        UsesHighPixelDensityBackBuffer = false;
    }
}
