// <auto-generated>
//  This code was generated by the following tool on 2025-10-29 22:11:42 GMT+00:00:
...
public static unsafe partial class SDL
{
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial SDL_PenDeviceType SDL_GetPenDeviceType(SDL_PenID instance_id);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial SDL_PropertiesID SDL_hid_get_properties(SDL_hid_device* dev);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial SDL_Surface* SDL_LoadPNG(CString file);

    [LibraryImport(LibraryName, EntryPoint = "SDL_LoadPNG_IO")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial SDL_Surface* SDL_LoadPNG_IO(SDL_IOStream* src, CBool closeio);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SavePNG(SDL_Surface* surface, CString file);

    [LibraryImport(LibraryName, EntryPoint = "SDL_SavePNG_IO")]
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SavePNG_IO(SDL_Surface* surface, SDL_IOStream* dst, CBool closeio);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SetGPURenderState(SDL_Renderer* renderer, SDL_GPURenderState* state);
    ...
    [UnmanagedCallConv(CallConvs = new[] { typeof(CallConvCdecl) })]
    public static partial CBool SDL_SetTexturePalette(SDL_Texture* texture, SDL_Palette* palette);
    ...
    public static readonly CString SDL_ELF_NOTE_DLOPEN_PRIORITY_RECOMMENDED = (CString)"recommended"u8;

    public static readonly CString SDL_ELF_NOTE_DLOPEN_PRIORITY_REQUIRED = (CString)"required"u8;

    public static readonly CString SDL_ELF_NOTE_DLOPEN_PRIORITY_SUGGESTED = (CString)"suggested"u8;
    ...
    public static readonly CString SDL_GPU_RENDERER = (CString)"gpu"u8;
    ...
    public static readonly CString SDL_HINT_AUDIO_DEVICE_RAW_STREAM = (CString)"SDL_AUDIO_DEVICE_RAW_STREAM"u8;
    ...
    public static readonly CString SDL_HINT_EMSCRIPTEN_FILL_DOCUMENT = (CString)"SDL_EMSCRIPTEN_FILL_DOCUMENT"u8;
    ...
    public static readonly CString SDL_HINT_INVALID_PARAM_CHECKS = (CString)"SDL_INVALID_PARAM_CHECKS"u8;
    ...
    public static readonly CString SDL_HINT_JOYSTICK_HIDAPI_FLYDIGI = (CString)"SDL_JOYSTICK_HIDAPI_FLYDIGI"u8;
    ...
    public static readonly CString SDL_HINT_JOYSTICK_HIDAPI_SINPUT = (CString)"SDL_JOYSTICK_HIDAPI_SINPUT"u8;
    ...
    public static readonly CString SDL_HINT_JOYSTICK_HIDAPI_SWITCH2 = (CString)"SDL_JOYSTICK_HIDAPI_SWITCH2"u8;
    ...
    public static readonly CString SDL_HINT_JOYSTICK_HIDAPI_ZUIKI = (CString)"SDL_JOYSTICK_HIDAPI_ZUIKI"u8;
    ...
    public static readonly CString SDL_HINT_KMSDRM_ATOMIC = (CString)"SDL_KMSDRM_ATOMIC"u8;
    ...
    public static readonly CString SDL_HINT_PS2_GS_HEIGHT = (CString)"SDL_PS2_GS_HEIGHT"u8;

    public static readonly CString SDL_HINT_PS2_GS_MODE = (CString)"SDL_PS2_GS_MODE"u8;

    public static readonly CString SDL_HINT_PS2_GS_PROGRESSIVE = (CString)"SDL_PS2_GS_PROGRESSIVE"u8;

    public static readonly CString SDL_HINT_PS2_GS_WIDTH = (CString)"SDL_PS2_GS_WIDTH"u8;
    ...
    public static readonly CString SDL_HINT_RENDER_DIRECT3D11_WARP = (CString)"SDL_RENDER_DIRECT3D11_WARP"u8;
    ...
    public static readonly CString SDL_HINT_VIDEO_METAL_AUTO_RESIZE_DRAWABLE = (CString)"SDL_VIDEO_METAL_AUTO_RESIZE_DRAWABLE"u8;
    ...
    public static readonly CString SDL_HINT_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS = (CString)"SDL_WINDOWS_RAW_KEYBOARD_EXCLUDE_HOTKEYS"u8;
    ...
    public static readonly int SDL_MICRO_VERSION = (int)3;
    ...
    public static readonly CString SDL_PROP_GPU_DEVICE_CREATE_D3D12_ALLOW_FEWER_RESOURCE_SLOTS_BOOLEAN = (CString)"SDL.gpu.device.create.d3d12.allowtier1resourcebinding"u8;
    ...
    public static readonly CString SDL_PROP_GPU_DEVICE_CREATE_FEATURE_ANISOTROPY_BOOLEAN = (CString)"SDL.gpu.device.create.feature.anisotropy"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_CREATE_FEATURE_CLIP_DISTANCE_BOOLEAN = (CString)"SDL.gpu.device.create.feature.clip_distance"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_CREATE_FEATURE_DEPTH_CLAMPING_BOOLEAN = (CString)"SDL.gpu.device.create.feature.depth_clamping"u8;

    public static readonly CString SDL_PROP_GPU_DEVICE_CREATE_FEATURE_INDIRECT_DRAW_FIRST_INSTANCE_BOOLEAN = (CString)"SDL.gpu.device.create.feature.indirect_draw_first_instance"u8;
    ...
    public static readonly CString SDL_PROP_HIDAPI_LIBUSB_DEVICE_HANDLE_POINTER = (CString)"SDL.hidapi.libusb.device.handle"u8;
    ...
    public static readonly CString SDL_PROP_IOSTREAM_MEMORY_FREE_FUNC_POINTER = (CString)"SDL.iostream.memory.free"u8;
    ...
    public static readonly CString SDL_PROP_NAME_STRING = (CString)"SDL.name"u8;
    ...
    public static readonly CString SDL_PROP_RENDERER_CREATE_GPU_DEVICE_POINTER = (CString)"SDL.renderer.create.gpu.device"u8;
    ...
    public static readonly CString SDL_PROP_RENDERER_TEXTURE_WRAPPING_BOOLEAN = (CString)"SDL.renderer.texture_wrapping"u8;
    ...
    public static readonly CString SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_POINTER = (CString)"SDL.texture.create.gpu.texture"u8;

    public static readonly CString SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_U_POINTER = (CString)"SDL.texture.create.gpu.texture_u"u8;

    public static readonly CString SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_UV_POINTER = (CString)"SDL.texture.create.gpu.texture_uv"u8;

    public static readonly CString SDL_PROP_TEXTURE_CREATE_GPU_TEXTURE_V_POINTER = (CString)"SDL.texture.create.gpu.texture_v"u8;
    ...
    public static readonly CString SDL_PROP_TEXTURE_CREATE_PALETTE_POINTER = (CString)"SDL.texture.create.palette"u8;
    ...
    public static readonly CString SDL_PROP_TEXTURE_GPU_TEXTURE_POINTER = (CString)"SDL.texture.gpu.texture"u8;

    public static readonly CString SDL_PROP_TEXTURE_GPU_TEXTURE_U_POINTER = (CString)"SDL.texture.gpu.texture_u"u8;

    public static readonly CString SDL_PROP_TEXTURE_GPU_TEXTURE_UV_POINTER = (CString)"SDL.texture.gpu.texture_uv"u8;

    public static readonly CString SDL_PROP_TEXTURE_GPU_TEXTURE_V_POINTER = (CString)"SDL.texture.gpu.texture_v"u8;
    ...
    public static readonly CString SDL_PROP_WINDOW_CREATE_EMSCRIPTEN_FILL_DOCUMENT_BOOLEAN = (CString)"SDL.window.create.emscripten.fill_document"u8;
    ...
    public static readonly CString SDL_PROP_WINDOW_EMSCRIPTEN_FILL_DOCUMENT_BOOLEAN = (CString)"SDL.window.emscripten.fill_document"u8;
    ...
    public static readonly int SDL_VERSION = (int)3003003;
    ...
    {
        [FieldOffset(0)]
        public SDL_Surface* surface; // size = 8

        [FieldOffset(8)]
        public uint duration; // size = 4
    }
    ...
    public partial struct SDL_GPUDepthStencilTargetInfo
    {
        ...
        [FieldOffset(30)]
        public byte mip_level; // size = 1

        [FieldOffset(31)]
        public byte layer; // size = 1
    }
    ...
    public partial struct SDL_Event
    {
        ...
        [FieldOffset(0)]
        public SDL_PinchFingerEvent pinch; // size = 24
    ...
    public enum SDL_CameraPermissionState : int
    {
    ...
    public enum SDL_PenDeviceType : int
    {
